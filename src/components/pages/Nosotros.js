...
// TODO(Ali) : checar este warning xq Cristina @yo, no le sé super bien
...
export default class Nosotros extends Component {
    ...
    componentDidMount() {
        ...
        .then((Snap) => {
            Snap.forEach(exodo => {
                console.log(exodo.data().tribus.size)
                tribus.push(this.getMapSize(exodo.data().tribus))
                miembros.push(exodo.data().cantidadExoditos)
            });
            var exodos_total = Snap.size
            var tribus_total = tribus.reduce(function(a, b){
                return a + b;
            }, 0);
            var miembros_total = miembros.reduce(function(a, b){
                return a + b;
            }, 0);
            this.setState({
                miembrosTotales : miembros_total,
                tribusTotales : tribus_total,
                exodosTotales : exodos_total,
                loading : false
            })
        });
    }
                    ...
                    <CardBody>
                        ...
                        <Jumbotron style={jumbotronStyle2}>
                            <Container>
                                ...
                                <Row>
                                    <Col>
                                        <p><div style={textSize1}>{this.state.tribusTotales}</div><br></br><div style={textColor}>TRIBUS REGISTRADAS</div></p>
                                    </Col>
                                    <Col>
                                        <p><div style={textSize1}>{this.state.miembrosTotales}</div><br></br><div style={textColor}>MIEMBROS TOTALES</div></p>
                                    </Col>
                                    <Col>
                                        <p><div style={textSize1}>{this.state.exodosTotales}</div><br></br><div style={textColor}>GRUPOS ÉXODO</div></p>
                                    </Col>
                                </Row>
                            </Container>
                        </Jumbotron>
