  ...
  render(){
    return (
      <div className='anuncios'>
        { this.state.anuncios.map((anuncio, index) => (<Anuncio anuncio={anuncio} key={index}></Anuncio>))}
      </div>
    )
  }
};
