...
function Exodo(exodo) {
  ...
  return (
    <Col xl={3} lg={4} md={6} sm={12}>
      <Card className='my-2'>
        <Image className='icono' src="https://cdn2.iconfinder.com/data/icons/thin-line-color-1/21/33-512.png"/>
        ...
        <Card.Body>
          ...
          <Image className='icono' src="https://image.flaticon.com/icons/png/512/1259/1259851.png"/>
        </Card.Body>
      </Card>
    </Col>
  )
