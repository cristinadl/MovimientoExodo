  ...
  render() {
    return (
      <Col xl={3} lg={4} md={6} sm={12}>
        <Card className='my-2'>
          <Card.Img style={{width: "125px",height: '125px',display: "block",marginLeft: "auto",marginRight: "auto"}} variant="top" src={this.state.logo} alt='No carga porque ps no hay nada'/>
          <Card.Body>
